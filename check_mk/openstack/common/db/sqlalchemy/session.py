...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/check_mk/sqlite.db",
        sqlite_db="/var/lib/check_mk/sqlite.db")
...
from check_mk.openstack.common.db import exception
from check_mk.openstack.common.gettextutils import _
from check_mk.openstack.common import log as logging
from check_mk.openstack.common import timeutils

DEFAULT = 'DEFAULT'

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='check_mk.sqlite',
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside check_mk
            index = file.rfind('check_mk')
            if index == -1:
                continue
